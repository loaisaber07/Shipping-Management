            ...
            modelBuilder.Entity("Data_Access_Layer.Entity.Branch", b =>
                {
                    ...
                    b.Property<DateTime>("DataAdding")
                        ...
                        .HasDefaultValue(new DateTime(2024, 9, 18, 3, 37, 23, 612, DateTimeKind.Local).AddTicks(9741));
            ...
            modelBuilder.Entity("Data_Access_Layer.Entity.FieldJob", b =>
                {
                    ...
                    b.Property<DateTime>("DateAdding")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 9, 18, 3, 37, 23, 613, DateTimeKind.Local).AddTicks(7728));
            ...
            modelBuilder.Entity("Data_Access_Layer.Entity.Order", b =>
                {
                    ...
                    b.Property<DateTime>("DateAdding")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 9, 18, 3, 37, 23, 614, DateTimeKind.Local).AddTicks(4531));
