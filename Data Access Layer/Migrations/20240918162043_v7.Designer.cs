            ...
            modelBuilder.Entity("Data_Access_Layer.Entity.Branch", b =>
                {
                    ...
                    b.Property<DateTime>("DataAdding")
                        ...
                        .HasDefaultValue(new DateTime(2024, 9, 18, 19, 20, 42, 174, DateTimeKind.Local).AddTicks(3971));
            ...
            modelBuilder.Entity("Data_Access_Layer.Entity.FieldJob", b =>
                {
                    ...
                    b.Property<DateTime>("DateAdding")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 9, 18, 19, 20, 42, 175, DateTimeKind.Local).AddTicks(3184));
            ...
            modelBuilder.Entity("Data_Access_Layer.Entity.Order", b =>
                {
                    ...
                    b.Property<DateTime>("DateAdding")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 9, 18, 19, 20, 42, 176, DateTimeKind.Local).AddTicks(48));
